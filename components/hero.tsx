      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center py-14 sm:py-20">
          <div className="mb-5 flex items-center gap-2">
            <Skull className="h-8 w-8 text-lime-300" />
            <p className="text-sm uppercase tracking-[0.25em] text-lime-300/80">studio</p>
          </div>
          <h1 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            <span className="block">ARTE AUTORAL &</span>
            <span className="block text-lime-300 drop-shadow-[0_0_20px_rgba(132,204,22,0.35)]">PIERCING</span>
            <span className="block">DE ELITE</span>
          </h1>
